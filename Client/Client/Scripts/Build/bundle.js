...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__APIService__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Components_Buttons_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Components_Charts_js__ = __webpack_require__(8);



__WEBPACK_IMPORTED_MODULE_0__Components_Buttons_js__["a" /* default */].Initialize();
__WEBPACK_IMPORTED_MODULE_1__Components_Charts_js__["a" /* default */].Initialize();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Table__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DataTable__ = __webpack_require__(7);
...
class Charts {
    ...
    Initialize() {
        ...
        __WEBPACK_IMPORTED_MODULE_2__Utility_NetworkService__["a" /* default */].getOfficerShootings().then(data => {
            ...
            __WEBPACK_IMPORTED_MODULE_1__OfficerShootingCharts__["a" /* default */].GetStackedBar(data);
        }).catch(error => {
            console.log(error);
        });
    }
...
class OfficerShootingCharts {
    ...
    GetStackedBar(dataSet) {
        ...
        for (var i = 0; i < dataSet.length; i++) {
            ...
            for (var j = 0; j < labels.length; j++) {
                ...
                if (dataSet[i].OFFICER_RACE === labels[j]) {
                    ...
                    if (dataSet[i].INDIVIDUAL_RACE === "White") whiteIndividuals[j]++;else if (dataSet[i].INDIVIDUAL_RACE === "Black") blackIndividuals[j]++;else if (dataSet[i].INDIVIDUAL_RACE === "Hispanic") hispanicIndividuals[j]++;else otherIndividuals[j]++;
                }
            }
        }
        ...
        let barChart = new __WEBPACK_IMPORTED_MODULE_0__Chart___default.a(stackedContainer, {
            type: 'bar',
            data: chartData,
            options: {
                title: {
    ...
    GetRadar(dataSet) {
        ...
        for (var i = 0; i < dataSet.length; i++) {
            ...
            if (dataSet[i].OFFICER_EXPERIENCE_YEARS <= 2) {
                ...
                if (dataSet[i].OFFICER_POLICY_VIOLATION === "YES") violation[0]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Fatal Injury') fatal[0]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Miss') miss[0]++;
            }

            if (dataSet[i].OFFICER_EXPERIENCE_YEARS <= 5) {

                if (dataSet[i].OFFICER_POLICY_VIOLATION === "YES") violation[1]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Fatal Injury') fatal[1]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Miss') miss[1]++;
            }

            if (dataSet[i].OFFICER_EXPERIENCE_YEARS <= 10) {

                if (dataSet[i].OFFICER_POLICY_VIOLATION === "YES") violation[2]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Fatal Injury') fatal[2]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Miss') miss[2]++;
            }

            if (dataSet[i].OFFICER_EXPERIENCE_YEARS <= 15) {

                if (dataSet[i].OFFICER_POLICY_VIOLATION === "YES") violation[3]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Fatal Injury') fatal[3]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Miss') miss[3]++;
            }

            if (dataSet[i].OFFICER_EXPERIENCE_YEARS <= 25) {

                if (dataSet[i].OFFICER_POLICY_VIOLATION === "YES") violation[4]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Fatal Injury') fatal[4]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Miss') miss[4]++;
            }

            if (dataSet[i].OFFICER_EXPERIENCE_YEARS <= 40) {

                if (dataSet[i].OFFICER_POLICY_VIOLATION === "YES") violation[5]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Fatal Injury') fatal[5]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Miss') miss[5]++;
            }

            if (dataSet[i].OFFICER_EXPERIENCE_YEARS > 40) {

                if (dataSet[i].OFFICER_POLICY_VIOLATION === "YES") violation[6]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Fatal Injury') fatal[6]++;

                if (dataSet[i].INDIVIDUAL_INJURY_TYPE == 'Miss') miss[6]++;
            }
        }
        ...
        let radarChart = new __WEBPACK_IMPORTED_MODULE_0__Chart___default.a(radarContainer, {
            type: 'radar',
            data: {
                labels: labels,
                datasets: [{
